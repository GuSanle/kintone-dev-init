...
class PreviewApp
{
     ...
     * @return array
     */
    public function postFields($id,  $fields, $guestSpaceId = null, $revision = -1): array
    {
        $options = ['json' => [
            'app' => $id,
            'properties' => $fields,
     ...
     * @return array
     */
    public function putFields($id, $fields, $guestSpaceId = null, $revision = -1): array
    {
        $options = ['json' => [
            'app' => $id,
            'properties' => $fields,
     ...
     * @return array
     */
    public function putViews($id, $views, $guestSpaceId = null, $revision = -1): array
    {
     ...
     * @return array
     */
    public function putCustomize($id, array $desktop = [], array $mobile = [], $guestSpaceId = null, $scope = 'ALL', $revision = -1): array
    {
        $options = ['json' => [
            'app' => $id,
            'desktop' => $desktop,
     ...
     * @return array
     */
    public function putStatus($id, $states, $actions, $enable = true, $guestSpaceId = null): array
    {
        $options = [
            'json' => [
                'app' => $id,
